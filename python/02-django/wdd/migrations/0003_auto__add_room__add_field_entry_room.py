...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.room'
        db.add_column('wdd_entry', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wdd.Room'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Room'
        db.delete_table('wdd_room')

        # Deleting field 'Entry.room'
        db.delete_column('wdd_entry', 'room_id')
