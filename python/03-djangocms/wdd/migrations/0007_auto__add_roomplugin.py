...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RoomPlugin'
        db.create_table('cmsplugin_roomplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wdd.Room'])),
        ))
        db.send_create_signal('wdd', ['RoomPlugin'])


    def backwards(self, orm):
        # Deleting model 'RoomPlugin'
        db.delete_table('cmsplugin_roomplugin')
    ...
    models = {
        ...
        'wdd.entry': {
            ...
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['wdd.Room']", 'null': 'True', 'blank': 'True'}),
        ...
        'wdd.roomplugin': {
            'Meta': {'object_name': 'RoomPlugin', 'db_table': "'cmsplugin_roomplugin'", '_ormbases': ['cms.CMSPlugin']},
